            ...
            <div className="hero-content py-5">
              <h1 className="text-lg-start fw-bold main-title">
                ...
                <span className="singkatan">
                  Sigap <br /> Pencegahan Stunting
                </span>
              </h1>
              <p className="text-lg-start mt-lg-2 main-content fs-5">SIPENTING merupakan website layanan pencegahan stunting yang bekerja sama dengan UPT Puskesmas Tirto Kota Pekalongan. Website ini memberikan layanan berupa konsultasi stunting, cek status gizi dan artikel edukasi mengenai pencegahan stunting.</p>
